...
/*
 ...
 Explanation: 整體解釋在 Weather.java
   1. Weather.java - abstract class, 基底的class, temperature, airQuality 跟 class 有組合關係 (ObjectStructure ?)
   2. Temperature.java - 繼承 Weather.java, 多一 getTempGraph function.
   3. AirQuality.java - 繼承 Weather.java, 多一 getAirQGraph function.
   4. VisitI.java - interface, 裡面有二個多型的函式,帶的參數不一樣, 這個interface會和 AirQuality & Temperature 產生關聯
...
public abstract class Weather {
    ...
    public abstract void accept(VisitI visit);  //跟VisitI產生關聯,但沒有人有用到他
}
